...
const messages: AgentMessageRow[] = [
  {
    ...
    content:
      "Generated twenty source-code product candidates. The strongest cluster is agency-resellable AI business tools with clear demos and low build complexity.",
    created_at: createdAt,
  },
  {
    id: "message-2",
  ...
  },
  {
    ...
    agent_id: "judge",
    content: `Build this first.\n\nWinner: ${winner.title}. It has the cleanest buyer story, the strongest agency resale value, and the fastest path to a polished LinkedIn demo.`,
    created_at: createdAt,
  },
];
